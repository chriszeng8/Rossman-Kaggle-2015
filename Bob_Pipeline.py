...
train_data.to_csv(path_or_buf='train_final.csv', sep=',')
test_data.to_csv(path_or_buf='test_final.csv', sep=',')
pdb.set_trace()
...
# np.savetxt("bob_cleaned_train_dummies.csv", final_train, fmt='%f', delimiter=',', newline='\n')
# np.savetxt("bob_cleaned_test_dummies.csv", x_test, fmt='%f', delimiter=',', newline='\n')
##########################################################################################################
...
RFR(x_train,y_train,x_test,udf_trees=50, udf_max_features=5)
#GBM(x_train,y_train,x_test, udf_trees=100, udf_lr=0.1, udf_max_depth=5, udf_minsam=250)
